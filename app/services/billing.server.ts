...
export const PLANS: PlanDefinition[] = [
  ...
  },
  {
    ...
    customerQuota: PLAN_QUOTAS.ENTERPRISE.customers,
    invoiceQuota: PLAN_QUOTAS.ENTERPRISE.invoices,
    features: [
...
export function billingPlanToEnum(planName: string | null): Plan {
  ...
  switch (planName) {
    // Shopify billing plan names (monthly / annual) — from charge.name
    ...
    case "TruCredit Free":
      return "FREE";
    // Shopify plan_handle values — from callback URL ?plan_handle=xxx
    case "trucredit-business":
      return "ENTERPRISE";
    case "trucredit-pro":
      return "PRO";
    case "trucredit-starter":
      return "STARTER";
    case "trucredit-free":
      return "FREE";
